...
import karnataka2 from '../assets/karnataka2.png'

export const Cinema = () => {
    return (
        <>
            <div style={{backgroundColor: "white", padding: "7px", color: "black", marginTop:"5px"}}>
                <img src={karnataka2} alt="" style={{width: "1500px", height:"600px", marginTop:"3px",marginBottom:"3px"}} />
